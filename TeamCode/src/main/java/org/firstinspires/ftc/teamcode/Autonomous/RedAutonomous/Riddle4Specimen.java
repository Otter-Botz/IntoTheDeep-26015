...
public class Riddle4Specimen extends LinearOpMode {
    ...
    public class armSlider {
        ...
        // init stuff
        public armSlider(HardwareMap hardwareMap){
            armSliderServo = hardwareMap.get(CRServo.class, "armSliderServo");
        }
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder sampleTransfer2 = drive.actionBuilder(
                        new Pose2d(lastX, lastY, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder specimenPickup1 = drive.actionBuilder(
                        new Pose2d(lastX, lastY, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(nextX, nextY), Math.toRadians(90))
                .waitSeconds(1);
        ...
        lastX = nextX;
        lastY = nextY;
        TrajectoryActionBuilder score2Pickup3 = drive.actionBuilder(new Pose2d(lastX, lastY, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder score3 = drive.actionBuilder(new Pose2d(lastX, lastY, Math.toRadians(90)))
