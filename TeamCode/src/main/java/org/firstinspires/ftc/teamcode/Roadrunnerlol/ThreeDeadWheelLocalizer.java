...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =   -1944.3604917422538;// y position of the first parallel encoder (in tick units)

        public double par1YTicks =  2140.13632305275 ;// y position of the second parallel encoder (in tick units)

        public double perpXTicks =  -2349.211993064938;// x position of the perpendicular encoder (in tick units)
